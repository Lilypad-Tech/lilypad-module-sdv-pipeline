...
echo "lilypad run sdv-pipeline:v1.0-lilypad$LILYPAD_SDV_V1_0 -i Prompt='An astronaut jumps through a field of clouds' -i Steps=200 -i VideoSteps=70"
echo "lilypad run sdv-pipeline:v1.1-lilypad$LILYPAD_SDV_V1_1 -i Prompt='An astronaut jumps through a field of clouds' -i Steps=200 -i VideoSteps=70"
echo
